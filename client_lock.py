...
password = input("To set up the password recovery tool, first enter the password you want to recover later on: ") # the password is the flag
print("Next, you will have to answer a series of 10 questions. The answers to these questions will be used to secure your password.")
